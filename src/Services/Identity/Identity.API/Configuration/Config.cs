...
namespace Microsoft.eShopOnContainers.Services.Identity.API.Configuration
{
    public class Config
    {
        ...
        public static IEnumerable<IdentityResource> GetResources() => new [] {new IdentityResources.OpenId() as IdentityResource, new IdentityResources.Profile()};

        // client want to access resources (aka scopes)
        public static IEnumerable<Client> GetClients(Dictionary<string, string> clientsUrl) => new [] {
            // JavaScript Client
            new Client {
                ClientId = "js",
